...
public interface ResponseExpectation {
     ...
     */
    ResponseExpectation content(final Object content);
     ...
     * @return this response
     */
    ResponseExpectation content(final Object content, final String contentType);
     ...
     * @return this response
     */
    ResponseExpectation content(final Object content, final ContentType contentType);
     ...
     * @return this response
     */
    ResponseExpectation header(final String name, final String... value);
     ...
     * @return this response
     */
    ResponseExpectation headers(final Map<String, Object> headers);
     ...
     * @return this response
     */
    ResponseExpectation allows(final HttpMethod... methods);
     ...
     * @return this response
     */
    ResponseExpectation cookie(final String name, final String value);
     ...
     * @return this response
     */
    ResponseExpectation cookie(final String name, final Cookie cookie);
     ...
     * @return this response
     */
    ResponseExpectation cookies(final Map<String, String> cookies);
     ...
     * @return this response
     */
    ResponseExpectation contentType(final String contentType);
     ...
     * @return this response
     */
    ResponseExpectation contentType(final ContentType contentType);
...
//    String getContentType()
     ...
     * @return this response
     */
    ResponseExpectation code(int code);
     ...
     * @return this response
     */
    ResponseExpectation delay(final long time);
     ...
     * @return this response
     */
    ResponseExpectation delay(final long time, TimeUnit unit);
     ...
     * @return this response
     */
    ResponseExpectation delay(final String time);
...
//    Integer getCode()
     ...
     */
    ResponseExpectation encoder(String contentType, Class objectType, Function<Object, String> encoder);
     ...
     * @return a reference to this response configuration
     */
    ResponseExpectation encoder(ContentType contentType, Class objectType, Function<Object, String> encoder);
     ...
     * @return a reference to this response configuration
     */
    ResponseExpectation encoders(ResponseEncoders encoders);
}
